...
2. **Część teoretyczna**
   ...
   **Szczegółowa specyfikacja urządzenia**
   ...
   https://www.tp-link.com/pl/products/details/cat-39_T2500G-10TS.html#specifications
...
Trzy kolejne switche, które zostaną umieszczone w serwerowni, open space i sali konferencyjnej to **TP-Link 52p T1600G-52TS**. Urządzenie to posiada 52 porty dzięki czemu mamy duży zapas na kolejne urządzenia sieciowe.

-Gigabitowe porty zapewniają pełną prędkość transmisji danych

-Rozbudowane funkcje zabezpieczające ruch sieciowy, w tym obsługa VLAN 802.1Q, Port Security oraz Storm control umożliwiają skuteczne zabezpieczenie sieci lokalnej.

-Możliwość zoptymalizowania transmisji głosowych oraz wideo dzięki funkcjom QoS (L2/L3/L4) oraz IGMP snooping.

-Zarządzanie poprzez przeglądarkę internetową, obsługa SNMP oraz RMON umożlwiają wygodne zarządzanie urządzeniem.

**Szczegółowa specyfikacja urządzenia**

https://www.tp-link.com/pl/products/details/TL-SG2452.html#specifications

![](https://static.tp-link.com/res/images/products/gallery/TL-SG2452.jpg)
...
Urządzenie, które wybraliśmy to **TP-Link EAP320**. Będzie on zamontowany w suficie.

-Prędkości do 1,2Gb/s łącznie w dwóch pasmach. 802,11ac Wi-Fi z 	 technologiami MIMO oraz TurboQAM

-Technologie Airtime Fairness, Beamforming, oraz Sterowanie pasmem zapewniają optymalne działanie

-Oprogramowanie zarządzające pozwala na centralne zarządzenie siecią bezprzewodową złożoną z setek urządzeń

-Uwierzytelnianie przy pomocy strony powitalnej

-Zasilanie poprzez PoE (802.3at) oraz łatwość montażu pozwalają na dowolne umiejscowienie urządzenia

**Szczegółowa specyfikacja urządzenia**

https://www.tp-link.com/pl/products/details/cat-5039_EAP320.html

![](https://static.tp-link.com/EAP320-01_1483596734208y.jpg)
...
Do przygotowania całej konstrukcji sieci potrzebny będzie budżet w wysokości 23635 tys zł.

 ![](https://i.imgur.com/QovtJaB.png)
